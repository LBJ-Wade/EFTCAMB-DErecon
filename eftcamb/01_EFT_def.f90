...
module EFT_def
    ...
    !real(dl), parameter :: EFTbackgroundcutoff = 1.d-3 !< Smallest scale factor that the code should
    ...
    real(dl), parameter :: EFTturnonpiInitial = 1.d-3   !< Turn on pi field flag:
    ...
    !real(dl), parameter :: EFTstabilitycutoff = 1.d-2
