...
!> AZ Test
!write(*,*) "output: a=",a
!write(*,*) "EFTCAMB flag:", CP%EFTCAMB%EFTflag
!write(*,*) "EFTCAMB active?",EV%EFTCAMBactive
!write(*,*)
...
!> AZ mod:
!write(*,*) "calculating the CMB TT source in EFTCAMB "
...
!> test
!write(*,*) "EFTturnOnTime, tau0:",EV%EFTturnOnTime,CP%tau0
    ! EFTCAMB MOD END
